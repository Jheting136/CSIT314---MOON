 ...
 */
export function meta({}: Route.MetaArgs) { // The argument is often empty if not using loader data etc.
  return [
    { title: "CleanConnect | Your Trusted Home Cleaning Matchmaker" },
    { name: "description", content: "Login or create an account to manage your cleaning needs." }, // Updated description
  ];
}
    ...
    <main className="bg-gradient-to-b from-gray-900 via-gray-950 to-black min-h-screen text-white flex flex-col justify-center items-center px-4">
      <section className="text-center max-w-xl">
        ...
        <p className="text-lg text-gray-300 mb-8">
          ...
          Your trusted platform for connecting homeowners and professional cleaners. Log in or create an account to get started.
        </p>
